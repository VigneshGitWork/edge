...
import { itineraryAppInit as itinerary } from "itinerary/ItineraryApp";
...
function Itinerary(props) {
	...
	console.log("-Itinerary app loaded::::");
	useEffect(() => {
		var requestOptions = {
			method: "GET",
			headers: {
	...
	React.useEffect(() => {
		if (ref.current && renderConfigDataFlag && !isEmpty(aemConfigData)) {
			itinerary(ref.current, { ...props, configJson: aemConfigData });
